...
const HighlyCriticalKpis = () => {
  ...
  const { toPDF, targetRef } = usePDF({
    filename: "National KPIs - Highly Critical.pdf",
  });
  ...
  return (
    <div>
      <Container className="dropdown__header CKR_pad py-1" fluid>
        <Row className="flex">
        ...
        <Container fluid>
          <Row className="mb-3 align-center">
            <Col md={6} className="flex justify-start items-center">
              <p className="prayas_breadcrums mb-0">
                ...
                <span>National KPIs - Highly Critical</span>
              </p>
            </Col>
          ...
          <div className="shadow__box">
            <div className="heading_container justify-center items-center ">
              ...
              <h3 className="text-center">National KPIs - Highly Critical</h3>
            ...
            <div ref={targetRef}>
              <CustomTable
                ...
                loader={loader}
                columns={columns}
                headerStyle="National_HighlyCritical"
              />
            </div>
          </div>
        </Container>
...
export default HighlyCriticalKpis;
