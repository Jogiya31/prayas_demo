...
const StateDistrictAnalysis = () => {
  ...
  const { toPDF, targetRef } = usePDF({
    filename: "State/District Analysis.pdf",
  });
  ...
  const columns = [
    ...
    columnHelper.accessor("Scheme_Name", {
      ...
      cell: (info) => {
        ...
        const Scheme_Name = info.row.original.Scheme_Name;
        return (
          <div className="flex justify-center items-center">
            <div className="flex-col flex items-center">
              <span className="font-semibold">{Scheme_Name}</span>
              <span>
                {`(Launched: ${moment(Start_Date).format("MMM DD, YYYY")} )`}
              </span>
            </div>
          </div>
        );
    ...
    columnHelper.accessor("value", {
      header: "Top District Value",
      cell: (info) => (
        <div className="flex justify-center items-center">
          <span className="font-semibold">19.1 L</span>
        </div>
      ),
    }),
  ];
        ...
        <Container fluid>
          ...
          <div className="shadow__box">
            <div className="heading_container justify-center items-center ">
              ...
              <h3 className="text-center">State/District Analysis</h3>
            ...
            <div ref={targetRef}>
              <CustomTable
                ...
                loader={loader}
                columns={columns}
                headerStyle="stateDistrictAnalysis"
              />
            </div>
          </div>
        </Container>
